    ...
    case (1):
      {
        ...
        head = solve1 (head, string, &compare1);
        break;
      }
    case (3):
      {
        ...
        head = solve1 (head, string, &compare3);
        break;
      }
    case (5):
      {
        ...
        head = solve1 (head, string, &compare5);
        break;
      }
    case (7):
      {
        head = solve7 (head, &compare7);
        break;
      }

    case (9):
      {
        head = solve7 (head, &compare9);
        break;
      }

    case (11):
      {
        head = solve11 (head, &compare11);
        break;
      }

    case (13):
      {
        head = solve11 (head, &compare13);
        break;
      }
    ...
    case (15):
      {
        ...
        string[strlen (string) - 1] = 0;
        head = solve15 (head, string, &compare1);
        break;
      }
    ...
    case (17):
      {
        ...
        string[strlen (string) - 1] = 0;
        head = solve15 (head, string, &compare3);
        break;
      }
    ...
    case (19):
      {
        ...
        string[strlen (string) - 1] = 0;
        head = solve15 (head, string, &compare5);
        break;
      }

    case (21):
      {
        head = solve21 (head, &compare21);
        break;
      }
    case (23):
      {
        head = solve21 (head, &compare7);
        break;
      }
    case (25):
      {
        ...
        string[strlen (string) - 1] = 0;
        head = solve25  (head, string, &compare25);
        break;
      }
    case (27):
      {
        ...
        string[strlen (string) - 1] = 0;
        head = solve25 (head, string, &compare5);
        break;
      }
    default :
      {
