...
int read(const char *name, double *x, double *y, double *d, int n)
{
	FILE *fp;
	int idx;
...
void print_function(double *x, double *y, double *d, int n)
{
	int idx,
