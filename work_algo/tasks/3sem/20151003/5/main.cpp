...
int main (int argc, char **argv)
{
  ...
  result = type_of_list (head);
  counter_of_time = (clock() - counter_of_time) / CLOCKS_PER_SEC;
  switch (result)
    {
      case (1):
        fprintf (stdout, "The list increases\n");
        break;
      case (2):
        fprintf (stdout, "The list decreases\n");
        break;
      case (3):
        fprintf (stdout, "The list is constant\n");
        break;
      case (4):
        fprintf (stdout, "There is not enought data to give answer\n");
        break;
      case (0):
        fprintf (stdout, "The list is not monotonic\n");
        break;
    }
  printf("Elapsed = %.3f\n", counter_of_time);
  delete head;
